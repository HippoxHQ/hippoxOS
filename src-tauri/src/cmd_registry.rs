...
pub fn register_handler() -> impl Fn(tauri::ipc::Invoke) -> bool + Clone + Send + Sync + 'static {
    tauri::generate_handler![
        ...
        commands::cmd_remove_track_blocks_batch,
        commands::cmd_remove_overlay_track_blocks_batch,
        ...
        commands::cmd_register_str_overlay,
        commands::cmd_list_str_overlays,
        commands::cmd_list_str_overlays_by_category,
        commands::cmd_add_srt_to_overlay_track,
