...
export const APP_WINDOW_EVENTS = {
    ...
    BLOCKCHAIN_SWITCH_SESSION: "APP_WINDOW_EVENT_BLOCKCHAIN_SWITCH_SESSION",
    ...
    BLOCKCHAIN_SESSION_CREATED: "APP_WINDOW_EVENT_BLOCKCHAIN_SESSION_CREATED",
...
> = {
    ...
    blockchain: { event: APP_WINDOW_EVENTS.BLOCKCHAIN_SWITCH_SESSION, panel: "blockchain" },
};
/**
