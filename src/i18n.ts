...
export const en: typeof zh = {
  ...
  workspace: {
    defaultSuccess: 'Successfully set "{{name}}" as default workspace',
    defaultFailed: 'Failed to set default workspace',
    deleteSuccess: 'Successfully deleted "{{name}}"',
    deleteFailed: 'Failed to delete workspace',
    addSuccess: 'Successfully added workspace "{{name}}"',
    ...
    deleteConfirmTitle: 'Confirm Delete',
    deleteConfirmMessage: 'Are you sure you want to delete workspace "{{name}}"? This action cannot be undone.',
    delete: 'Delete',
  },
  knowledge: {
