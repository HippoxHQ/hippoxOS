...
export const MapsChatPageEarthView: React.FC<MapsChatPageEarthViewProps> = ({ theme, i18n, onLoad, onMapClick, onMoveEnd, mapData, taskId }) => {
  ...
  const addBarChartLayer = useCallback((barData: any[]) => {
    ...
    if (!barLayer) {
      barLayer = new BarChartLayer("llm-barcharts", "llm barcharts", {
        visible: true,
        zIndex: 75,
        maxHeight: 80,
      });
