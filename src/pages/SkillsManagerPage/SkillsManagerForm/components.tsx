        ...
        <div className="dependencies-section">
          ...
          <div className="dependencies-list">
            {availableDeps.map((depStep) => (
              <div key={depStep.id} className={`dependency-chip ${step.dependencies.includes(depStep.id) ? "selected" : ""}`} onClick={() => onToggleDependency(step.id, depStep.id)}>
                ...
                <div key={material.id} className="material-item">
                  <div className="material-row">
                    ...
                    <input
                      ...
                      onChange={(e) => onUpdateMaterial(step.id, material.id, "content", e.target.value)}
                  ...
                  {material.type === "link" && (
                    <div className="material-schema">
                      ...
                      <textarea
                        ...
                        onChange={(e) => onUpdateMaterial(step.id, material.id, "inputSchema", e.target.value)}
                      ...
                      <textarea
                        ...
                        onChange={(e) => onUpdateMaterial(step.id, material.id, "outputSchema", e.target.value)}
...
export const FormLabel: React.FC<FormLabelProps> = ({ required, children }) => <label className={`form-label ${required ? "required" : ""}`}>{children}</label>;
