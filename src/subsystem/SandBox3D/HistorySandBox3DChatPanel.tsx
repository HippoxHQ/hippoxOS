...
const HistorySandBox3DChatPanel = forwardRef<HistorySandBox3DChatPanelRef, HistorySandBox3DChatPanelProps>(({ t, onSessionSelect, currentSessionId, onNewSession, isBatchMode = false, selectedIds = new Set(), onToggleSelection }: HistorySandBox3DChatPanelProps, ref) => {
    ...
    try {
      ...
      const sorted = [...list].sort((a, b) => {
        ...
        const getTimestamp = (id: string) => {
          const ts = id.replace("sandbox3d_session_", "");
